# -*- encoding: utf-8 -*-
# stub: decidim-proposals 0.21.0 ruby lib

Gem::Specification.new do |s|
  s.name = "decidim-proposals".freeze
  s.version = "0.21.0"
  ...
  s.date = "2020-04-08"
  s.description = "A proposals component for decidim's participatory spaces.".freeze
  ...
  s.summary = "Decidim proposals module".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<doc2text>.freeze, ["~> 0.4.2"])
      s.add_runtime_dependency(%q<kaminari>.freeze, ["~> 1.1"])
      s.add_runtime_dependency(%q<ransack>.freeze, ["~> 2.1.1"])
      ...
      s.add_development_dependency(%q<decidim-budgets>.freeze, ["= 0.21.0"])
      s.add_development_dependency(%q<decidim-dev>.freeze, ["= 0.21.0"])
      s.add_development_dependency(%q<decidim-meetings>.freeze, ["= 0.21.0"])
      ...
      s.add_dependency(%q<doc2text>.freeze, ["~> 0.4.2"])
      s.add_dependency(%q<kaminari>.freeze, ["~> 1.1"])
      s.add_dependency(%q<ransack>.freeze, ["~> 2.1.1"])
