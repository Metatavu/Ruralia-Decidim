# -*- encoding: utf-8 -*-
# stub: decidim-accountability 0.21.0 ruby lib

Gem::Specification.new do |s|
  s.name = "decidim-accountability".freeze
  s.version = "0.21.0"
  ...
  s.date = "2020-04-08"
  s.description = "An accountability component for decidim's participatory spaces.".freeze
  ...
  s.summary = "Decidim accountability module".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<decidim-proposals>.freeze, ["= 0.21.0"])
    else
