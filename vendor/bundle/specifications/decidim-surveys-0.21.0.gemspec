# -*- encoding: utf-8 -*-
# stub: decidim-surveys 0.21.0 ruby lib

Gem::Specification.new do |s|
  s.name = "decidim-surveys".freeze
  s.version = "0.21.0"
  ...
  s.date = "2020-04-08"
  s.description = "A surveys component for decidim's participatory spaces.".freeze
  ...
  s.summary = "Decidim surveys module".freeze
