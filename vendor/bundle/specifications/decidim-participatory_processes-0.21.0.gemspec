# -*- encoding: utf-8 -*-
# stub: decidim-participatory_processes 0.21.0 ruby lib

Gem::Specification.new do |s|
  s.name = "decidim-participatory_processes".freeze
  s.version = "0.21.0"
  ...
  s.date = "2020-04-08"
  s.description = "Participatory processes component for decidim.".freeze
  ...
  s.summary = "Decidim participatory processes module".freeze
