# -*- encoding: utf-8 -*-
# stub: decidim-budgets 0.21.0 ruby lib

Gem::Specification.new do |s|
  s.name = "decidim-budgets".freeze
  s.version = "0.21.0"
  ...
  s.date = "2020-04-08"
  s.description = "A budgets component for decidim's participatory spaces.".freeze
  ...
  s.summary = "Decidim budgets module".freeze
