# -*- encoding: utf-8 -*-
# stub: decidim-system 0.21.0 ruby lib

Gem::Specification.new do |s|
  s.name = "decidim-system".freeze
  s.version = "0.21.0"
  ...
  s.date = "2020-04-08"
  s.description = "System administration to create new organization in an installation.".freeze
  ...
  s.summary = "Decidim system administration".freeze
